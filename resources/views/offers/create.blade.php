<x-app-layout>
    <div class="mx-16 my-4">
        <h1 class="mb-6">Créer une offre</h1>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div>
                                    ...
                                    <x-input id="name" class="inline-block mt-1 w-3/5" type="text" name="name" :value="old('name')" required autofocus />
                                </div>

                                <!-- Contact -->
                                <div class="mt-3">
                                    <x-label for="contact" :value="__('Contact')" class="text-sm text-gray-500 inline-block mr-6" />
                                    <x-input id="contact" class="inline-block mt-1 w-3/5" type="text" name="contact" :value="old('contact')" required />
                                </div>
                            </div>
                            <div>
                                <!-- Email -->
                                <div>
                                    ...
                                    <x-input id="email" class="inline-block mt-1 w-3/5" type="email" name="email" :value="old('email')" required />
                                </div>

                                <!-- Adresse -->
                                <div class="mt-3">
                                    <x-label for="address" :value="__('Adresse')" class="text-sm text-gray-500 inline-block mr-6" />
                                    <x-input id="address" class="inline-block mt-1 w-3/5" type="text" name="address" :value="old('address')" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div>
                                    ...
                                    <x-input id="libelle" class="inline-block mt-1 w-3/5" type="text" name="title" :value="old('title')" required />
                                </div>

                                <!-- Catégorie -->
                                <div class="mt-3">
                                    <x-label for="category" :value="__('Catégorie')" class="text-sm text-gray-500 inline-block mr-3" />
                                    <select name="category" id="category" class="inline-block mt-1 w-3/5 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" :value="old('category')" required>
                                ...
                                <div class="mt-8">
                                    ...
                                    <textarea name="overview" id="overview" cols="56" rows="5" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                                </div>
                            </div>
                            <div>
                                <!-- Durée -->
                                <div>
                                    ...
                                    <x-input id="worktime" class="inline-block mt-1 w-3/5" type="text" name="worktime" :value="old('worktime')" required />
                                </div>

                                <!-- Budget -->
                                <div class="mt-3">
                                    <x-label for="budget" :value="__('Budget')" class="text-sm text-gray-500 inline-block mr-6" />
                                    <x-input id="budget" class="inline-block mt-1 w-3/6" type="text" name="budget" :value="old('budget')" required />
